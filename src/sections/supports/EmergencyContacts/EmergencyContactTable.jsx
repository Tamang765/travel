...
import { deleteEmergencyContact } from "../../../redux/slices/emergencyContactSlice";
...
export default function EnhancedTable({
  ...
  const fetchLoading = useSelector(
    (state) => state.emergencyContact.fetchLoading
  );
  ...
  return (
    <>
      ...
      <EditDialog
        open={openEditModal}
        title={`Edit emergency contact (${dataToEdit?.name})`}
      ...
      <ConfirmDialog
        ...
        title={`Are you sure, you want to delete contact(${dataToEdit?.name})?`}
        action={
          <Button
