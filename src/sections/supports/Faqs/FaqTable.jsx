...
export default function EnhancedTable({
  ...
  const deleteLoading = useSelector((state) => state.faq.isLoading);
  const fetchLoading = useSelector((state) => state.faq.fetchLoading);
  ...
  return (
    <>
      ...
      <EditDialog
        open={openEditModal}
        title={`Edit FAQ (${dataToEdit?.question})`}
      ...
      {/* TODO: delete faq confirm modal */}
      <ConfirmDialog
        handleClose={() => setOpenConfirmModal(false)}
        open={openConfirmModal}
        title={`Are you sure, you want to delete faq(${dataToEdit?.question})?`}
        action={
          <Button
