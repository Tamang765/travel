...
import { deleteSize } from "../../../redux/slices/sizeSlice";
...
export default function EnhancedTable({
  ...
  const deleteLoading = useSelector((state) => state.size.isLoading);
  const fetchLoading = useSelector((state) => state.size.fetchLoading);
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title={`Are you sure, you want to delete size model(${dataToEdit?.name})?`}
        action={
          <Button
