...
import { deleteVehicleSymbol } from "../../../../redux/slices/vehicleSlice";
...
export default function EnhancedTable({
  ...
  const deleteLoading = useSelector((state) => state.vehicle.isLoading);
  const fetchLoading = useSelector((state) => state.vehicle.fetchLoading);
  ...
  return (
    <>
      ...
      <EditDialog
        open={openEditModal}
        title={`Edit symbol (${dataToEdit?.title})`}
      ...
      <ConfirmDialog
        ...
        title={`Are you sure, you want to delete symbol(${dataToEdit?.title})?`}
        action={
          <Button
