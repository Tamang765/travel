...
import { deleteVehicleModel } from "../../../../redux/slices/vehicleSlice";
...
export default function EnhancedTable({
  ...
  return (
    <>
      ...
      <EditDialog
        open={openEditModal}
        title={`Edit model (${dataToEdit?.name})`}
      ...
      <ConfirmDialog
        ...
        title={`Are you sure, you want to delete vehicle model(${dataToEdit?.name})?`}
        action={
          <Button
