...
export default function EnhancedTable({
  ...
  const deleteLoading = useSelector((state) => state.role.isLoading);
  const fetchLoading = useSelector((state) => state.role.fetchLoading);
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title={`Are you sure, you want to delete role(${dataToEdit?.name})?`}
        action={
          <Button
