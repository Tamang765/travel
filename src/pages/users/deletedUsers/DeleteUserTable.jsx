                ...
                return (
                  ...
                  >
                    ...
                    <TableCell
                      ...
                      onClick={(event) => handleClick(event, row.active)}
                    >
                    ...
                    <TableCell
                      ...
                      onClick={(event) => handleClick(event, row.tripCount)}
                    >
                      {row.tripCount}
                    </TableCell>
                    ...
                    <TableCell
                      ...
                      onClick={(event) => handleClick(event, row.deletedAt)}
                    >
                      {moment(row.deletedAt).format("MMM DD, YYYY")}
                    </TableCell>
                  </TableRow>
                );
              })}
