...
export const AddAmenitiesBill = () => {
  return (
    <>
      <Shadow>
        <TitleMd>AddAmenities Bill</TitleMd>
        <AddAmenitiesBillForm />
      </Shadow>
    </>
  );
};

export const AddAmenitiesBillForm = () => {
  return (
    <>
      <form className="w-2/3">
        <div className="my-8 flex gap-7 flex-col">
          ...
          <div className="flex">
            <h3 className="text-primary capitalize font-medium flex w-64">
              Select Amenities <span className="text-red-500 ml-2">*</span>
            </h3>
            <div className="w-full flex items-center gap-5">
              <Select label="Select Version">
                <Option>Material Tailwind HTML</Option>
