          ...
          <div className="flex justify-between mt-8 w-full">
            <div className="w-2/3">
              ...
              <div className="grid grid-cols-3 gap-5 my-8">
                <CardSm
                  title="Total revenue"
                  caption="previous months vs this months"
                  total="$5,900"
                  subtitle="55% Higher"
...
export const HomeImg = () => {
  ...
  return (
    <div
      ...
      className={`rounded-lg flex items-center shadow-md drop-shadow-md`}
    >
      <img src={dasImg} alt="dasImg" />
      <div className="text p-6">
        <h1 className="text-xl font-medium text-white">John Doe</h1>
        <p className="text-s mt-2 leading-5 text-white">
  ...
  const dataLine = {
    ...
    options: {
      ...
      xaxis: {
        ...
        labels: {
          style: {
            colors: colors.text, // Set text color for x-axis labels
          },
        },
      },
    },
