...
export const TablesPage = () => {
  return (
    <>
      <Shadow>
        <EnhancedTable title="Tables" />
      </Shadow>
    </>
  );
};

function createData(name, noseats, table) {
  return {
    name,
    noseats,
    table,
...
const rows = [
  createData("101", "2", "Table 1"),
  createData("102", "3", "Table 2"),
  createData("103", "3", "Table 3"),
  createData("104", "4", "Table 4"),
];
                ...
                <form className="flex flex-col gap-5">
                  <div className="flex">
                    <h3 className="text-primary capitalize text-sm font-medium flex w-64">
                      Table Number<span className="text-red-500 ml-2">*</span>
                    </h3>
