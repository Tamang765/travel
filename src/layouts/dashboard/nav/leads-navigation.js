...
const navConfig = [
    ...
    items: [
      {
        ...
        icon: ICONS.blogs,
        children: [
          { title: "Blogs list", path: PATH_DASHBOARD.news.list },
          { title: "Create new blog", path: PATH_DASHBOARD.news.add },
        ],
      },
      {
        title: "Pages",
        ...
        icon: ICONS.pages,
        children: [
          { title: "Pages list", path: PATH_DASHBOARD.pages.list },
          { title: "Create New Page", path: PATH_DASHBOARD.pages.create },
        ],
      },
...

  {
    ...
    items: [
      {
        title: "Clients",
        path: PATH_DASHBOARD.players.root,
        icon: ICONS.user,
        children: [
          { title: "Clients list", path: PATH_DASHBOARD.players.list },
